...
describe GscDigitalProducts::Claims do
  ...
  describe "#professional_services" do
    ...
    it "submit an accident-related claim" do
      # Arrange
      request = GscDigitalProducts::ProfessionalServicesClaimRequest.new(
        subscriber_identifier: "260901",
        dependant_number: "00",
        ...
        benefit_type_code: GscDigitalProducts::BenefitTypeCode::PS,
        provider_id: "3380639",
        accident_type: GscDigitalProducts::AccidentType::WSIB,
        accident_date: Date.new(1918, 11, 11),
        wsib_case_number: "453",
        claim_details: [{
          hours: 1,
          claim_amount: 100.00,
          service_date: Date.new(2023, 2, 20),
      ...
      expect(@http_client).to receive(:post).with(
        ...
        JSON.parse('[
          {
              "claimFormId": 1021251467,
              "claimFormRevisionNumber": 1009259139,
              "subscriberId": 260901,
              "dependantNumber": "00",
              "participantName": "Jim Jones",
              "submissionDate": "2023-04-03T00:00:00",
              "benefitTypeCode": "PS",
              "providerId": 3250291,
              "submissionTypeCode": "OL",
              "claimTypeCode": "CL",
              ...
              "reasonCode": "NA",
              "claimSubmissionReferenceNumber": null,
              "lastUpdatedDate": "2023-04-03T14:59:35Z",
              "claimDetails": [
                  {
                      "claimDetailId": 1259974766,
                      "claimFormId": 1021251467,
                      "claimId": 1258323115,
                      "claimRevisionNumber": 1273732475,
                      "procedureCode": "33520",
                      "benefitDescriptionShort": "Professional Service",
                      "benefitDescription": {
                          "en": "Counsellor, Social Worker",
                      ...
                      "benefitTypeCode": "PS",
                      "toothCode": 0,
                      "serviceDate": "2023-03-28T00:00:00",
                      "claimAmount": 3.01,
                      "otherPaidAmount": 0,
                      "deductibleAmount": 0,
                      "copayAmount": 0,
      ...
      # Assert
      expect(result.claim_details[0].claim_amount).to eq(3.01)
      expect(result.claim_details[0].paid_amount).to eq(3.01)
      expect(result.claim_details[0].copay_amount).to eq(0.0)
      expect(result.claim_details[0].deductible_amount).to eq(0.0)
    end
  end
